...
import { NormalButton, NormalInput, Normalselect } from '../../components/common';
...
import { createCandidateByCandidate } from '../../api/candidate'
// import './candidateFrom.scss'

export const CandidateIndividualForm = ({ sucessSaved = '', onClose = '' }) => {
        ...
        <div className='container mt-4'>
            ...
            <div className="row mt-2">
                <div className='col-md-12 col-sm-12'>
                    <h4 className='title-form'>Candidate Info Form</h4>
                    <p className='title-form'>This form is to get detailed information about our each valuable student who has enrolled in this institute and for our purpose too. </p>
                </div>
            </div>
            <div className="row mt-2">
